<div class="container">
	...
	<div class="row mt-2 mb-3 card">
		<div class="col mt-3 mb-3">
			...
			<?php echo form_open(base_url() . 'extras/edit/' . $extra['extra_id'], array('class'=>'form-inline')) ?>
			...
			<div class="form-group mx-sm-3 mb-2">
				...
				<input type="text" value="<?php echo $extra['extra_price'] ?>" class="form-control" name="price"  id="name" placeholder="Precio para: <?php echo $extra['size_name'] ?>" required>
			</div>
